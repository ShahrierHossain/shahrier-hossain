    ...
    >
      ...
      >
        ...
        😑 amm... well, actually I want to be a <span className="font-bold italic">Researcher</span>.
         Highly interested in <span className="font-bold italic">Neuro Data Science</span>, <span className="font-bold italic">Brain Computer Interactions</span>. and <span className="font-bold italic"> Human Behaviour & Psychology </span>.
      </motion.h1>
